...
const Nav = ({ setShowModal }) => {
  ...
  return (
    <header className="bg-peridot-purple relative my-6 mx-12 max-sm:mx-6 rounded-full backdrop-blur-lg z-50">
      <nav className="max-container flex justify-between items-center gap-20 px-9 py-3">
        ...
        {mobileMenuOpen && (
          <div className="fixed top-20 left-0 right-0 z-50 bg-peridot-purple w-full p-6 flex flex-col justify-center items-center lg:hidden rounded-xl text-deep-purple">
